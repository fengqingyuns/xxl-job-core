...
import com.example.demo.dao.YaGaoRepository;
...
public abstract class Init {
    ...
    @Autowired
    YaGaoRepository yaGaoRepository;
   /* @Autowired
    ...
    public void init() {
        ...
        Iterable<YaGao> yaGaos = yaGaoRepository.findAll();
        if (yaGaos.iterator().hasNext()) {
            return;
        }
        for(int i=0;i<3;i++) {
        	YaGao ya = new YaGao();
        	ya.setId(i+"");
        	ya.setName(getYaGao().get(i).getName());
        	ya.setNum(getYaGao().get(i).getNum());
        	ya.setDsc(getYaGao().get(i).getDsc());
        	ya.setTags(getYaGao().get(i).getTags());
        	ya.setSex(getYaGao().get(i).getSex());
        	yaGaoRepository.save(ya);
        }
    ...
    private List<YaGao> getYaGao(){
    	String s[] = {"美容","美白"};String s1[] = {"健齿"};String s2[] = {"防蛀","健齿"};
    	List<YaGao> list = new ArrayList<YaGao>();
    	YaGao yg = new YaGao();
    	yg.setName("heiren");
    	yg.setNum(4+"");
    	yg.setSex("男");
    	...
    	yg.setTags(s);
    	YaGao yg1 = new YaGao();
    	yg1.setName("jiajieshi");
    	yg1.setNum(8+"");
    	yg1.setDsc("键齿");
    	yg1.setSex("女");
    	yg1.setTags(s1);
    	YaGao yg2 = new YaGao();
    	yg2.setName("gaolujie");
    	yg2.setNum(10+"");
    	yg2.setDsc("防蛀");
    	YaGao yg3 = new YaGao();
    	yg2.setName("meiren");
    	...
    	yg2.setDsc("防蛀");
    	yg2.setTags(s2);
    	list.add(yg);list.add(yg1);list.add(yg2);
    	return list;
